 ...
 function ChangeView(txt, img, obj, link){

    obj_id = $(obj).attr("id");

    if (obj_id == "main_news_1"){mainvideo_iter = 1}

    if (obj_id == "main_news_2"){mainvideo_iter = 2}

    if (obj_id == "main_news_3"){mainvideo_iter = 3}

    if (obj_id == "main_news_4"){mainvideo_iter = 4}

    if (obj_id == "main_news_5"){mainvideo_iter = 5}

    over = 1;

    $('.top_care_buttons a').removeClass('atm');

    $(obj).addClass('atm');

    $('#main_image').attr('src', img);

    $('#main_news_href1').attr('href', link);

    $('#main_news_href2').attr('href', link);

    $("#main_content p").html(txt);
